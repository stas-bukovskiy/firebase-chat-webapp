...
<template>
  <div>
            ...
            <div class="message-text d-flex flex-column"
              ...
              <div v-if="props.attachmentsUrl.length" class="d-flex flex-wrap gap-2 mb-2">
                <AttachmentComponent v-for="(url, index) in props.attachmentsUrl" :key="index" :chatId="props.chatId"
                                     :fileUrl="url" @preview="handleAttachmentPreviewClick"/>
              </div>
    ...
    <n-modal v-if="props.attachmentsUrl" v-model:show="showAttachmentPreview">
      <AttachmentPreviewComponent :attachments="props.attachmentsUrl" :initial-url="attachmentPreviewUrl"
